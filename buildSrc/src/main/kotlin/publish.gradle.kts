        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/piyushjohnson/newsblock/")
                    ...
                    developers {
                        developer {
                            id.set("piyushjohnson")
                            name.set("piyushjohnson")
                        }
                    }
                    scm {
                        connection.set("scm:git:git://github.com/piyushjohnson/newsblock.git")
                        developerConnection.set("scm:git:ssh://github.com/piyushjohnson/newsblock.git")
                        url.set("https://github.com/piyushjohnson/newsblock/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/piyushjohnson/newsblock/issues")
                    }
                }
            }
        }
